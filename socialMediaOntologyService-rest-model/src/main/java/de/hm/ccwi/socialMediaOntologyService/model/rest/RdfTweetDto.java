package de.hm.ccwi.socialMediaOntologyService.model.rest;
...
import de.hm.ccwi.socialMediaOntologyService.base.dto.AbstractDto;
 ...
 */
@XmlRootElement
public class RdfTweetDto extends AbstractDto {
	 ...
	 * @param tripleList
	 */
	public RdfTweetDto(Boolean searchSubject, String subjectForSearch, Boolean searchPredicate,
